<?php $page_title="Manage DNS Extream codes";
    ...
    if(!isset($_GET['keyword'])){
        $sql_query="SELECT * FROM tbl_xui_dns ORDER BY tbl_xui_dns.`id` DESC"; 
    } else{
        $keyword=addslashes(trim($_GET['keyword']));
        $sql_query="SELECT * FROM tbl_xui_dns WHERE (`dns_title` LIKE '%$keyword%' OR `dns_base` LIKE '%$keyword%') ORDER BY tbl_xui_dns.`id` DESC"; 
    }
