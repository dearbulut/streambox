                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <div class="nsofts-input-icon nsofts-input-icon--left">
                                        ...
                                        <input type="text" name="dns_title" class="form-control" placeholder="Enter your title" value="<?php if(isset($_GET['dns_id'])){echo $row['dns_title'];}?>" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <div class="nsofts-input-icon nsofts-input-icon--left">
                                        ...
                                        <input type="text" name="dns_base" class="form-control" placeholder="Enter your dns" value="<?php if(isset($_GET['dns_id'])){echo $row['dns_base'];}?>" required>
                                    </div>
                                </div>
                            </div>
