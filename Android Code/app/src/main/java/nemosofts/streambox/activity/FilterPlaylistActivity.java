...
public class FilterPlaylistActivity extends AppCompatActivity {
    ...
    private GetChannelPlaylist loadLive;
    private int pos = 0;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(FilterPlaylistActivity.this, true);
        ...
        findViewById(R.id.iv_filter).setOnClickListener(v -> DialogUtil.filterDialog(this, 1, () ->
    ...
    private void getDataCat() {
        new GetCategory(this, 4, new GetCategoryListener() {
            @Override
            public void onStart() {
                progressDialog.show();
            }
    ...
    private void getData() {
        loadLive = new GetChannelPlaylist(this, page, catName, new GetChannelListener() {
            @Override
            public void onStart() {
    ...
    public void setAdapterToCatListview() {
        ...
        if (ApplicationUtil.isAdultsCount(arrayListCat.get(0).getName())){
            DialogUtil.childCountDialog(this, pos, pos2 -> getData());
        } else {
            getData();
        }
    ...
    private void recreateData(int position) {
        if (!arrayListCat.isEmpty() && position < arrayListCat.size()) {
            ...
            new Handler(Looper.getMainLooper()).postDelayed(() -> {
                ...
                isLoading = false;
                page = 1;
                if (ApplicationUtil.isAdultsCount(arrayListCat.get(position).getName())){
                    DialogUtil.childCountDialog(this, pos, pos2 -> getData());
                } else {
                    getData();
                }
            ...
            Toasty.makeText(FilterPlaylistActivity.this,true, getString(R.string.err_no_data_found), Toasty.ERROR);
        }
    }
