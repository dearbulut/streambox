...
public class PlaylistLiveTvActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(PlaylistLiveTvActivity.this, true);
        helper = new Helper(this, (position, type) -> openPlayerLiveActivity(position));
    ...
    private void openPlayerLiveActivity(int position) {
        Intent intent = new Intent(PlaylistLiveTvActivity.this, PlayerLiveActivity.class);
